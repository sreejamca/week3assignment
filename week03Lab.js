 ...
 * 
 * ↓ YOUR CODE HERE ↓ */
let arrayStr=alphabetString.split('');
...
let alphString=alphabetArray.join('');
 ...
 * ↓ YOUR CODE HERE ↓ */
var myToDoList=[];
console.log(myToDoList.push("cooking","Washing","reading"));
console.log(myToDoList.splice(1,1));
var yourToDoList=["write","dance"];
...
var arrlength1=array1.length;
var arrlength2=array2.length;
if(arrlength1>arrlength2){
       return array1;
       
}else if(arrlength1==arrlength2){
       return false;
}else(arrlength1<arrlength2)
       return array2;
